...
const translations = {
  ...
  de: {
    ...
    'achievements.totalPoints': 'Gesamtpunkte',
    'achievements.completion': 'Vollständigkeit',
    'achievements.achieved': 'Erfolge erreicht',
    'achievements.all': 'Alle',
    'achievements.progress': 'Fortschritt',
    'achievements.streak': 'Serie',
    'achievements.special': 'Spezial',
    'achievements.unlockedOn': 'Freigeschaltet am',
    'common.of': 'von',
